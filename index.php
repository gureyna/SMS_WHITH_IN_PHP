...
<head>
    ...
    <title>Waraxma School| High quality education</title>
...
<body>
                ...
                <div class="container">
                   <div class="row home-detail">
                      ...
                      <div class="col-md-7 homexp">
                           ...
                           <h2>Waraxma School</h2>
                           <span>Home <a class="text-info" href="#">High quality education</a> </span>
                           <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam.</p>
                          
                           <button class="btn btn-info">View More Detail</button> 
                          
                       </div>
                       
                       <div class="col-md-5 hom-form">
                          <div class="registration-form row no-margin">
                              <h5>Register Online for Free</h5>
                              
                              <input placeholder="Enter Full Name" type="text" class="form-control" required>
                              <input placeholder="EnterEmail Address" type="text" class="form-control" required>
                              ...
                              <button class="btn w-100 btn-info" href="#">Apply Now</button>
                          </div>
    ...
    <div class="why-choos-us container-fluid">
          ...
          <div class="session-title">
            ...
            <div class="why-ro row ">
                <div class="col-lg-4 col-md-6">
                    <div class="col-card ">
                        <div class="icon ">
                            <i class="text-info far fa-calendar-plus"></i>
                        </div>
                        <div class="detail">
     ...
     <div id="courses" class="cources container-fluid">
           <div class="container">
                 ...
                 <div class="col-md-3 col-sm-6 cord-div">
                     <div class="cours-card">
                         ...
                         <div class="course-detail">
                             <h5>Accounting</h5>
                             <p>Lorem ipsum dolor sit amet consetuer ing elit diam uismod tincidunt Lorem ipsum li dolor </p>
                         </div>
        ...
        <div class="container">
            ...
            <div class="row teamro">
                <div class="col-md-3 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="assets/images/team/team-memb1.jpg">
                        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                             <img src="assets/images/team/team-memb2.jpg">
                        </div>
           ...
           <div class="container">
              <div class="row">
                <div class="gallery-filter d-none d-sm-block">
                    <button class="btn btn-default btn-sm filter-button" data-filter="all">All</button>
                    <button class="btn btn-default btn-sm filter-button" data-filter="hdpe">Finance</button>
                    <button class="btn btn-default btn-sm filter-button" data-filter="sprinkle">Digital Marketing</button>
                    <button class="btn btn-default btn-sm filter-button" data-filter="spray"> Money</button>
                    <button class="btn btn-default btn-sm filter-button" data-filter="irrigation">Business Alaysis</button>
                </div>
                <br/>
                ...
                <div class="col-lg-4 col-md-12 footer-form">
                    <div class="form-card">
                        ...
                        <div class="form-body">
                            ...
                            <button class="btn btn-sm btn-success w-100">Send Request</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="footer-copy">
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        <p>Copyright © <a href="https://dev.sommilk.com/">WaraxmaTech</a> | All right reserved.</p>
                    </div>
