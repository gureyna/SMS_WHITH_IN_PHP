...
<?php  include("includes/top-nav.php") ?>
            ...
            <!-- body Start -->
             ...
             <div class="container-fluid pt-4 px-4">
                ...
                <div class="pagetitle">
      <h3 class="breadcrumb-item active">Register Teacher</h3>
      <nav>
        <ol class="breadcrumb">
    ...
    <!-- Vertical Form -->
    <form action="add_teacher.php" method="post" class="row g-3">
      <div class="col-12">
    ...
    <?php 
                           ...
                           if (isset($_POST['save'])) {
                               ...
                               $query = "INSERT INTO teacher (name, email, phone, subject, address, gender) VALUES ('$name', '$email', '$phone', '$subject', '$address', '$gender')";
